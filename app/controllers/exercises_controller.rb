class ExercisesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @exercise.save
        format.html { redirect_to course_path(@course), notice: "Exercise was successfully created." }
  ...
  private
    ...
    def exercise_params
      params.require(:exercise).permit(:title, :content, :correction, :slug, :user_id, :course_id)
    end
end
